...
class SubMenuOrders extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <ModalOrders modalSubMenu={this.state.modalSubMenu} tableModalClicked={this.state.tableModalClicked} hideModalSubMenu={this.hideModalSubMenu} />
        <div className={classSubMenuOrders} bellonof={this.props.bellonof}>
          <button className="containerEachOrderSubMenu" value="MESA 1" onClick={this.showModalSubMenu}>Pedido mesa 1</button>
          <button className="containerEachOrderSubMenu" value="MESA 2" onClick={this.showModalSubMenu}>Pedido mesa 2</button>
          <button className="containerEachOrderSubMenu" value="MESA 3" onClick={this.showModalSubMenu}>Pedido mesa 3</button>
          <button className="containerEachOrderSubMenu" value="MESA 4" onClick={this.showModalSubMenu}>Pedido mesa 4</button>
          <button className="containerEachOrderSubMenu" value="MESA 5" onClick={this.showModalSubMenu}>Pedido mesa 5</button>
          <button className="containerEachOrderSubMenu" value="MESA 6" onClick={this.showModalSubMenu}>Pedido mesa 6</button>
        </div>
      </div>
    )
  };
  ...
  return (
    <div className={classModal}>
      <section className="containerModalSubMenu">
        <button onClick={hideModalSubMenu}>
          X
        </button>
      ...
      <div style={{ backgroundColor: "#c7c2c2" }}>
        ...
        <div className="containerTablesView">
          <div className="containerButtonsTables">
            <Link to="/mesero/mesa">
              <button className="buttonsTables" value="MESA 1" onClick={this.tableChoose}>
                Mesa 1
              </button>
            </Link>
            <Link to="/mesero/mesa">
              <button className="buttonsTables" value="MESA 2" onClick={this.tableChoose}>
                Mesa 2
              </button>
            </Link>
            <Link to="/mesero/mesa">
              <button className="buttonsTables" value="MESA 3" onClick={this.tableChoose}>
                Mesa 3
              </button>
            </Link>
            <Link to="/mesero/mesa">
              <button className="buttonsTables" value="MESA 4" onClick={this.tableChoose}>
                Mesa 4
              </button>
            </Link>
            <Link to="/mesero/mesa">
              <button className="buttonsTables" value="MESA 5" onClick={this.tableChoose}>
                Mesa 5
              </button>
            </Link>
            <Link to="/mesero/mesa">
              <button className="buttonsTables" value="MESA 6" onClick={this.tableChoose}>
                Mesa 6
              </button>
            </Link>
          </div>
